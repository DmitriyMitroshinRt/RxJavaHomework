...
// Почему? Single - исполнится и завершится событием Success или Error
// Дописать функцию
...
// Почему? Completable - важено только выплнение запроса а не результат
// Дописать функцию
...
// Почему? Maybe - из БД можно получить null
// Дописать функцию
